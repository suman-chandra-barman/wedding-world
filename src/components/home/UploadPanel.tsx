      ...
      <div className="group relative overflow-hidden w-50 sm:w-full mx-auto rounded-[0.85rem] border border-dashed border-[#ceb9a7] bg-[#f8f3ee] text-[#b48b6a] shadow-[inset_0_1px_0_rgba(255,255,255,0.65)]">
        {!uploadedImage ? (
          <button
            ...
            className="flex min-h-40 md:min-h-50 w-full cursor-pointer flex-col items-center justify-center gap-3 bg-[linear-gradient(180deg,#fbf7f3_0%,#f5eee8_100%)] px-6 py-10 text-[#b48b6a] transition hover:bg-[#f7f0ea]"
          >
            <ArrowUpFromLine />
          ...
          <>
            <Image
              src={uploadedImage}
              alt="Uploaded user"
              className="h-40 md:h-50 w-full object-cover"
              width={300}
              height={400}
            />
